...
const skins = {
  ...
  "P250": {
    "Thorned Stars": {
      variants: ["FN"],
      factors: ["ColorMap", "MetalnessMap", "NormalMap", "RoughnessMap"],
      settings: {skinId: "thornedstars", collection: "Alpha", rarity: "purple"}
    }
  },
  "Talon": {
    "Doppler Emerald": {
    ...
    "Blood Moon": {
      variants: ["FN"],
      factors: ["ColorMap", "NormalMap", "RoughnessMap"],
      settings: {skinId: "bloodmoon", collection: "Unknown", rarity: "gray"}
    },
    "Marble Fade": {
      variants: ["FN"],
  ...
  "AK-47": {
    ...
    "Veteran": {
      variants: ["FN"],
      factors: ["ColorMap", "MetalnessMap", "NormalMap", "RoughnessMap"],
      settings: {skinId: "veteran", collection: "Alpha", rarity: "blue"}
    },
    "DoodleAJob": {
      variants: ["FN"],
      factors: ["ColorMap", "MetalnessMap", "NormalMap", "RoughnessMap"],
